module github.com/bytepunx/kluster

go 1.26.3

require (
	github.com/bytepunx/kluster-lib v0.0.0
...
require (
	...
	github.com/bytepunx/signet v0.6.1 // indirect
...
replace github.com/bytepunx/kluster-lib => ../kluster-lib
